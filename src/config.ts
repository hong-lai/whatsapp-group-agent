...
export const config = {
    ...
    mediaDelayMinMs: envInt('MEDIA_DELAY_MIN_MS', 400),
    mediaDelayMaxMs: envInt('MEDIA_DELAY_MAX_MS', 1200),
    ...
    catchupGapMaxPages: envInt('CATCHUP_GAP_MAX_PAGES', 200),
    catchupHistoryRetryMax: envInt('CATCHUP_HISTORY_RETRY_MAX', 8),
    historyRetryMinMs: envInt('HISTORY_RETRY_MIN_MS', 8000),
    historyRetryMaxMs: envInt('HISTORY_RETRY_MAX_MS', 60_000),
    mediaRetryMaxAttempts: envInt('MEDIA_RETRY_MAX_ATTEMPTS', 8),
    mediaRetryMinMs: envInt('MEDIA_RETRY_MIN_MS', 10_000),
    mediaRetryMaxMs: envInt('MEDIA_RETRY_MAX_MS', 5 * 60_000),
